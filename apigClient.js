...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://ej01r9741b.execute-api.us-east-1.amazonaws.com/Dev';
    ...
    apigClient.adminPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var adminPostRequest = {
        ...
        return apiGatewayClient.makeRequest(adminPostRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.signinPost = function (params, body, additionalParams) {
        ...
        alert("Please wait while we log in");
